// Dafny program a.dfy compiled into C#
...
[assembly: DafnyAssembly.DafnySourceAttribute(@"// Dafny 3.2.0.30713
// Command Line Options: /spillTargetCode:1 a.dfy
// a.dfy
...
predicate minimal(a: int, b: int, n: int)
  decreases a, b, n
{
  !exists c: int, d: int :: valid(c, d, n) && abs(c - d) < abs(a - b)
}
...
namespace _module {
  ...
  public partial class __default {
    public static void get__coins(BigInteger n, out BigInteger a, out BigInteger b)
    {
      a = BigInteger.Zero;
      b = BigInteger.Zero;
      ...
      } else if ((Dafny.Helpers.EuclideanModulus(n, new BigInteger(3))) == (BigInteger.One)) {
        a = (Dafny.Helpers.EuclideanDivision(n, new BigInteger(3))) + (BigInteger.One);
        b = Dafny.Helpers.EuclideanDivision(n, new BigInteger(3));
      } else {
        a = Dafny.Helpers.EuclideanDivision(n, new BigInteger(3));
...
namespace CF {
    using static _module.__default;
    class CF_1551A {
