...
url = 'https://nadc21.kattis.com/standings?filter='
...
data = []
data.extend(get_teams_from_school("3554"))
data.extend(get_teams_from_school("3555"))
data.extend(get_teams_from_school("3556"))
data.extend(get_teams_from_school("3557"))
